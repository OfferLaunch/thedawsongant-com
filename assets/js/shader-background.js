// ShaderBackground — vanilla port of the 21st.dev Mesh drift shader
(function () {
...
void main() {
  ...
  const UNIFORMS = {
    colors: [
      [0.012, 0.110, 0.149],                    // #031C26 deep navy
      [0.106, 0.424, 0.659],                    // #1B6CA8 blue
      [0.353, 0.824, 0.957],                    // #5AD2F4 bright blue
      [0.0, 0.0, 0.0],                          // black (replaces white)
      [0.0, 0.0, 0.0],
      [0.012, 0.110, 0.149],
      [0.106, 0.424, 0.659],
      [0.353, 0.824, 0.957],
  ...
  function initShaderBackground(canvas) {
    ...
    return function cleanup() {
      ...
      const releaseTimer = window.setTimeout(function () {
