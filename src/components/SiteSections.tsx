...
const faqs = [
  {
    q: "Who is Dawson Gant?",
    a: "Dawson Gant is a 27-year-old Scottsdale operator, real estate investor, and growth strategist. He started in real estate at 18, flipped or built over a hundred houses, ran a sales and marketing agency that scaled clients to multiple seven figures per month, then entered telehealth at 27 and built a brand to seven figures in four months.",
  },
  {
    q: "What does Dawson Gant do?",
    a: "Dawson Gant runs a growth operations practice that partners with operators and founders to scale their offers past seven figures. He also invests in Scottsdale real estate, operates a telehealth venture, and gives significantly to charitable organizations.",
  },
  {
    q: "Where is Dawson Gant based?",
    a: "Dawson Gant is based in Scottsdale, Arizona. He runs his real estate investments, growth partnerships, and telehealth ventures from there.",
  },
  {
    q: "How many houses has Dawson Gant flipped?",
    a: "Dawson Gant has flipped or built over a hundred houses since starting at 18. He still invests actively in the Scottsdale market across acquisitions, renovations, and ground-up construction.",
  },
  {
    q: "Is Dawson Gant a pilot?",
    a: "Yes. Dawson Gant holds a private pilot license and flies regularly. He also races competitively and plays a public course in Scottsdale most mornings.",
  },
  {
    q: "How old is Dawson Gant?",
    a: "Dawson Gant is 27 years old. He started his career at 18, which puts him at nearly a decade of operating across real estate, agency work, telehealth, and growth partnerships.",
  },
  {
    q: "Where did Dawson Gant go to school?",
    a: "Dawson Gant attended North Carolina A&T State University and left to build full-time. He has spent his career in Scottsdale since.",
  },
  {
    q: "What philanthropy does Dawson Gant support?",
    a: "Dawson Gant has donated seven figures across several organizations, including Big Brothers Big Sisters Miami, where he funds youth mentorship programs.",
  },
  {
    q: "What is Dawson Gant's business philosophy?",
    a: "Dawson Gant operates rather than advises. He works inside the business alongside his partners, builds systems that compound, and measures himself by what he builds and gives back rather than what he announces.",
  },
];
      ...
      <section id="faq" className="py-20 md:py-28">
        <Container>
          ...
          <div className="grid items-start gap-10 md:grid-cols-2 md:gap-16">
            <div>
              {faqs.map(({ q, a }) => (
                <div key={q} className="reveal border-b border-border py-7">
